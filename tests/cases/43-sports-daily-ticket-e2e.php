...
test('daily ticket E2E: qualified ticket awaits user approval', function () {
    ...
    assert_true($ticket['total_odds'] >= 1.85 && $ticket['total_odds'] <= 3.5, 'odds inside configured (default 1.85–3.50) range');
    ...
    // FLAT_PERCENT staking default: 1.5% of the 1000 bankroll = 15.00.
    assert_equals(15.0, (float) $ticket['stake']);
