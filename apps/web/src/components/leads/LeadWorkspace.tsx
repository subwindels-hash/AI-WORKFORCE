  ...
  return <>
    ...
    <main className="mx-auto max-w-7xl px-4 py-8 sm:px-6">
      <header className="mb-7 flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        <div><p className="text-xs font-semibold uppercase tracking-[.24em] text-cyan-400">Scout / Sales intelligence</p><h1 className="mt-2 text-3xl font-bold text-white">{mode === "pipeline" ? "Lead pipeline" : "Lead discovery"}</h1><p className="mt-2 max-w-2xl text-slate-400">Discover real businesses, keep an auditable source record, and move qualified prospects through your pipeline.</p></div>
