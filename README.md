...
| Switch | What it does |
|---|---|
| `php tools/check_mql.php` | Dependency-free contract check for the MT4/MT5 Expert Advisors: balanced sources, every platform condition implemented in both terminals, every order behind `AIWF_AllowNewTrades()`, and the heartbeat/decision fields the three languages share. Exits non-zero on drift. |
