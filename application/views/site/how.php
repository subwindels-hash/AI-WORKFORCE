...
<section class="band">
  <ol class="steps">
    ...
    <li><span>03</span><div><h3>Role check</h3><p>Members go to <span class="mono">/dashboard</span>. Super administrators go to <span class="mono">/admin</span>. A member who opens an admin URL sees Access denied.</p></div></li>
...
<section class="band alt">
  ...
  <ul class="checklist">
    <li>Open /dashboard, /analysis, /admin or any module console</li>
