...
// No kill-switch pill here: the switch is scoped to broker + trading-intelligence
// order paths (AIWorkforce\KillSwitchPolicy) and this hero is the cross-module
// overview. The trading consoles (/analysis, /app/trading, /execution, /brokers,
// /risk, /paper) and the Command Center's Trading Intelligence card report it.
