...
// Same day as the operator reads it off the ticket (MM/DD/YYYY, UTC). It sits
// next to the button — which day the ticket is for must be visible, not only
// present in a hidden input.
