...
<head>
  ...
  <title><?= e(($title ?? 'Register') . ' · Africa Mobility') ?></title>
...
<body class="auth-page">
  <main class="auth-shell">
    <section class="auth-art">
      <img src="/assets/images/aegis-mark.png" alt="" class="auth-logo">
      <p class="eyebrow">Africa Mobility</p>
      <h1>Create a member workspace.</h1>
      <p>New accounts receive the platform_member role. Dashboards stay closed until this form succeeds.</p>
    </section>
    <section class="auth-card">
      <div class="auth-brand"><img src="/assets/images/aegis-mark.png" alt="" class="auth-brand-mark"><div><strong>Africa Mobility</strong><small>Create account</small></div></div>
      <h2>Register</h2>
