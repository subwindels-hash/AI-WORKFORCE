...
<div class="panel" style="margin-top:14px" id="security"><h3>Security</h3><div class="body"><p class="dim">Authentication uses the password hash stored in the database and sessions use the configured server-side session driver. Preserve <span class="mono">VP_ENCRYPTION_KEY</span> when migrating this installation to another cPanel account.</p><?php if ($this->platform->identity->can($user, 'system.super_admin')): ?><a class="btn" href="/admin">Open administrator controls</a><?php endif; ?></div></div>
