...
<body class="auth-page">
  <main class="auth-shell">
    <section class="auth-art">
      ...
      <p class="eyebrow">AEGIS Intelligence</p>
    ...
    <section class="auth-card">
      <div class="auth-brand"><img src="/assets/images/aegis-mark.png" alt="" class="auth-brand-mark"><div><strong>AEGIS</strong><small>AI Intelligence Platform</small></div></div>
      ...
      <form method="post" action="/login/submit" class="auth-form" autocomplete="on">
        ...
        <button class="btn primary auth-submit" type="submit"><?= $admin ? 'Enter admin control' : 'Sign in to AEGIS' ?></button>
      </form>
      <div class="auth-links">
        <?php if ($admin): ?><a href="/login">User sign in</a><?php else: ?><a href="/admin/login">Administrator sign in</a><?php endif; ?>
