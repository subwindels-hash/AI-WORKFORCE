  ...
  <section id="ai_workforce-chat-panel" class="ai_workforce-chat-panel" hidden role="dialog" aria-label="WINDELS Assistant">
    ...
    <form class="ai_workforce-chat-form">
      <div class="ai_workforce-chat-typing-session">
        <label class="ai_workforce-chat-typing-label" for="ai_workforce-chat-input">WINDELS Assistant typing session</label>
      ...
      <div class="ai_workforce-chat-controls">
        <div class="ai_workforce-chat-voice-controls">
          <button type="button" class="ai_workforce-chat-mic" id="ai_workforce-chat-mic" aria-label="Speak">🎤 Speak</button>
        ...
        <button type="submit" class="ai_workforce-chat-send" aria-label="Send message">Send</button>
      </div>
    </form>
