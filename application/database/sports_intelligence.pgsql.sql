...
CREATE TABLE IF NOT EXISTS "sports_configurations" (
  ...
  "target_odds_min" DECIMAL(10,4) NOT NULL DEFAULT 2.0,
  ...
  "min_expected_value" DECIMAL(8,5) NOT NULL DEFAULT 0.03,
  "max_correlation" VARCHAR(8) NOT NULL DEFAULT 'LOW',
  "min_data_quality" SMALLINT NOT NULL DEFAULT 55,
  ...
  "staking_mode" VARCHAR(20) NOT NULL DEFAULT 'FLAT',
