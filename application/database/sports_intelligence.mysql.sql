...
CREATE TABLE IF NOT EXISTS sports_configurations (
  ...
  target_odds_min DECIMAL(10,4) NOT NULL DEFAULT 1.85,
  target_odds_max DECIMAL(10,4) NOT NULL DEFAULT 3.5,
  ...
  min_expected_value DECIMAL(8,5) NOT NULL DEFAULT 0.05,
  max_correlation VARCHAR(8) NOT NULL DEFAULT 'LOW',
  min_data_quality SMALLINT NOT NULL DEFAULT 60,
  ...
  -- Staking discipline: FLAT or FRACTIONAL_KELLY (see StakeSizer).
  staking_mode VARCHAR(20) NOT NULL DEFAULT 'FLAT_PERCENT',
  bankroll DECIMAL(14,2) NOT NULL DEFAULT 1000,
  stake_percent DECIMAL(5,2) NOT NULL DEFAULT 1.5,
  kelly_fraction DECIMAL(5,4) NOT NULL DEFAULT 0.25,
