...
class Api_system extends Api_controller
{
    public const FEATURES = [
        ...
        ['name' => 'Lottery data providers (official feeds)', 'category' => 'module', 'status' => 'PLANNED', 'detail' => 'Authorized/official EuroMillions sources (and future lotteries) added one at a time with license metadata; a clearly-labeled sandbox simulation exists for pipeline testing only'],
        // platform
